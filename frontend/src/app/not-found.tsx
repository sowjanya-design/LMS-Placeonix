...
export default function NotFound() {
  return (
    <div
      ...
      style={{ background: "linear-gradient(160deg, #ede7fb 0%, #e3f0f9 35%, #e1f5ee 65%, #fbe9da 100%)" }}
    >
      <div
      ...
      >
        ...
        />
        <div className="mb-1 text-sm font-bold tracking-[2px] text-purple uppercase">404</div>
        <h1 className="mb-2 text-2xl font-extrabold text-ink">Lost your way?</h1>
        ...
        <Link
          ...
          style={{ background: "var(--clay-ink)", boxShadow: "var(--clay-shadow-btn)" }}
        >
          Back to Dashboard
        </Link>
      </div>
