...
router.get('/correction', authorize('mentor', 'admin'), ctrl.getCorrectionRequests);
router.put('/correction/:id/approve', authorize('mentor', 'admin'), ctrl.approveCorrection);
router.put('/correction/:id/reject', authorize('mentor', 'admin'), ctrl.rejectCorrection);
