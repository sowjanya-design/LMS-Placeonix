  ...
  try {
    ...
    const mentor1 = await User.create({
      ...
      mentorProfile: {
        ...
        experience: 6,
        qualifications: ["B.Tech CSE", "MERN Certified"],
        rating: 4.8,
        totalReviews: 16,
      },
    });
      ...
      modules: [
        {
          ...
          duration: "2 weeks",
          topics: [
            { title: "HTML5 Semantics", duration: 60 },
            { title: "CSS Flexbox & Grid", duration: 90 },
          ],
        },
        {
          order: 2,
          ...
          duration: "3 weeks",
          topics: [
            { title: "Variables & Scope", duration: 60 },
            { title: "Async/Await", duration: 90 },
          ],
        },
        {
          order: 3,
          ...
          duration: "4 weeks",
          topics: [
            { title: "Components", duration: 90 },
            { title: "Hooks", duration: 120 },
          ],
        },
        {
          order: 4,
    ...
    const sapFico = await Course.create({
      ...
      category: "ERP",
      description:
        "Master SAP Financial Accounting & Controlling with live SAP S/4HANA server access.",
    ...
    await Course.insertMany([
      // ─── SAP Cloud — Modern SAP Modules ───
      {
        ...
        createdBy: admin._id,
        description:
          "Flagship 5-module SAP cloud & modern dev stack: BTP, CAP, UI5/Fiori and CPI for working professionals.",
        shortDescription: "Complete SAP Cloud & Modern Dev Stack — 5 modules",
        duration: "4-6 Months",
        level: "Beginner to Advanced",
        fee: { amount: 65000 },
        tags: ["SAP BTP", "SAP CAP", "UI5/Fiori", "SAP CPI"],
      },
      {
        title: "SAP BTP (Cloud Platform)",
        category: "ERP",
        color: "#7c3aed",
        isPublished: true,
        createdBy: admin._id,
        description:
          "SAP Business Technology Platform with HANA Cloud — the foundation of modern SAP development.",
        shortDescription: "BTP + HANA Cloud",
        duration: "6-8 Weeks",
        level: "Intermediate",
        fee: { amount: 33000 },
        tags: ["BTP", "HANA"],
      },
      {
        ...
        createdBy: admin._id,
        description:
          "Cloud Platform Integration — build integration flows and APIs across SAP and non-SAP systems.",
        shortDescription: "Integration Flows + API",
        duration: "6-8 Weeks",
        level: "Intermediate",
        fee: { amount: 33000 },
        tags: ["Flows", "API"],
      },
      {
        ...
        createdBy: admin._id,
        description:
          "Cloud Application Programming Model with Node.js and CDS for full-stack SAP cloud apps.",
        shortDescription: "Node.js + CDS",
        duration: "6-8 Weeks",
        level: "Intermediate",
        fee: { amount: 33000 },
        tags: ["Node", "CDS"],
      ...
      {
        title: "SAP RAP (ABAP RESTful)",
        category: "ERP",
        color: "#4f46e5",
        isPublished: true,
        createdBy: admin._id,
        description:
          "ABAP RESTful Application Programming model building OData V4 services on S/4HANA.",
        shortDescription: "OData V4 services",
        duration: "6-8 Weeks",
        level: "Advanced",
        fee: { amount: 36000 },
        tags: ["OData V4", "RAP"],
      },
      {
        ...
        createdBy: admin._id,
        description:
          "Build responsive SAP Fiori apps with the SAPUI5 framework.",
        shortDescription: "Fiori Apps",
        duration: "6-8 Weeks",
        level: "Intermediate",
        fee: { amount: 28000 },
        tags: ["Fiori", "UI5"],
      ...
      {
        title: "SAP ABAP / S4HANA",
        category: "ERP",
        color: "#d97706",
        isPublished: true,
        createdBy: admin._id,
        description:
          "Core ABAP development on S/4HANA — RICEF objects and CDS views.",
        shortDescription: "RICEF + CDS",
        duration: "6-8 Weeks",
        level: "Beginner to Advanced",
        fee: { amount: 25000 },
        tags: ["RICEF", "CDS"],
      ...
      // ─── SAP Core — Functional Modules ───
      {
        ...
        createdBy: admin._id,
        description:
          "SAP Materials Management — procurement and inventory for supply chain professionals.",
        shortDescription: "Materials Management",
        duration: "2-3 Months",
        level: "Intermediate",
        fee: { amount: 22000 },
        tags: ["SAP", "Procurement"],
      },
      {
        title: "SAP SD",
        category: "ERP",
        ...
        createdBy: admin._id,
        description:
          "SAP Sales & Distribution — order-to-cash for sales and distribution teams.",
        shortDescription: "Sales & Distribution",
        duration: "2-3 Months",
        level: "Intermediate",
        fee: { amount: 22000 },
        tags: ["SAP", "Sales"],
      },
      {
        ...
        createdBy: admin._id,
        description:
          "SAP BASIS administration — system administration for IT professionals.",
    ...
    const batchA = await Batch.create({
      name: "Full Stack — Online Batch A",
      code: "FS-A-2025",
    ...
    const batchC = await Batch.create({
      ...
      mode: "offline",
      venue: "Kapil Kavuri Hub, 9th Floor — Hyderabad",
      capacity: 25,
      enrolledCount: 1,
      status: "active",
      createdBy: admin._id,
    ...
    liveEnd.setMinutes(liveEnd.getMinutes() + 90);
    await Session.insertMany([
      {
        ...
        endTime: liveEnd,
        mode: "online",
        meetingLink: "https://meet.google.com/placeonix-live",
        status: "live",
        agenda: ["useState", "useEffect", "Custom hooks"],
        createdBy: admin._id,
      },
      {
        title: "Live Coding: REST APIs with Node.js",
        batch: batchA._id,
        course: fullStack._id,
        instructor: mentor1._id,
        startTime: dayAt(1, 18),
        endTime: dayAt(1, 20),
        mode: "online",
        meetingLink: "https://meet.google.com/placeonix-live",
        status: "scheduled",
        agenda: ["Express routing", "JWT auth", "Live Q&A"],
        createdBy: admin._id,
      },
      {
        ...
        course: fullStack._id,
        instructor: mentor1._id,
        startTime: dayAt(3, 18),
        endTime: dayAt(3, 20),
        mode: "online",
        meetingLink: "https://meet.google.com/placeonix-live",
        status: "scheduled",
        agenda: ["Context API", "Redux Toolkit basics", "When to lift state"],
        createdBy: admin._id,
      },
      {
        ...
        course: fullStack._id,
        instructor: mentor1._id,
        startTime: dayAt(5, 18),
        endTime: dayAt(5, 20),
        mode: "online",
        meetingLink: "https://meet.google.com/placeonix-live",
        status: "scheduled",
        agenda: ["DSA quick round", "Project walkthrough", "Resume feedback"],
        createdBy: admin._id,
      },
      {
    ...
    await Session.insertMany([
      {
        title: "SAP FICO: Organizational Structure",
        batch: batchC._id,
        course: sapFico._id,
        instructor: mentor1._id,
        startTime: dayAt(-6, 8),
        ...
        status: "completed",
        recordingUrl: REC[0],
        agenda: ["Company code", "Chart of accounts", "Fiscal year variant"],
        createdBy: admin._id,
      },
      {
        title: "SAP FICO: General Ledger Accounting",
        batch: batchC._id,
        course: sapFico._id,
        instructor: mentor1._id,
        startTime: dayAt(-4, 8),
        ...
        status: "completed",
        recordingUrl: REC[1],
        agenda: ["GL master data", "Document posting", "Account groups"],
        createdBy: admin._id,
      },
      {
        ...
        status: "completed",
        recordingUrl: REC[2],
        agenda: ["Vendor master", "Invoice posting", "Outgoing payments"],
        createdBy: admin._id,
      },
      {
        title: "SAP FICO: Accounts Receivable",
        batch: batchC._id,
        course: sapFico._id,
        instructor: mentor1._id,
        startTime: dayAt(1, 8),
        endTime: dayAt(1, 10),
        mode: "offline",
        venue: "Kapil Kavuri Hub, 9th Floor",
        status: "scheduled",
        agenda: ["Customer master", "Incoming payments", "Dunning basics"],
        createdBy: admin._id,
      },
    ]);
    ...
    await Attendance.insertMany([
      ...
      ...genAttendance(student1._id, batchC._id, mentor1._id, 18, 0.8),
      ...genAttendance(student2._id, batchA._id, mentor1._id, 24, 0.74),
      ...genAttendance(student3._id, batchB._id, mentor2._id, 20, 0.7),
    ]);
    ...
    await Resource.insertMany([
      ...
      {
        title: "SAP FICO Configuration Handbook",
        type: "document",
        fileUrl:
          "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
        course: sapFico._id,
        accessLevel: "enrolled",
        uploadedBy: mentor2._id,
      },
      {
        title: "SAP FICO Class Notes",
        type: "pdf",
        fileUrl:
          "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
        course: sapFico._id,
    ...
    await Lead.insertMany([
      {
        ...
        phone: "9876543210",
        courseInterestedName: "Full Stack",
        source: "website",
        status: "new",
      },
      {
        ...
        phone: "9876501234",
        courseInterestedName: "Data Science",
        source: "referral",
        status: "contacted",
      },
      {
      ...
      },
      {
        ...
        phone: "9001122334",
        courseInterestedName: "UI/UX Design",
        source: "walk-in",
        status: "new",
      },
      {
    ...
    await Payment.insertMany([
      ...
      },
      {
        ...
        paidOn: dayAt(-10, 10),
        installmentNumber: 2,
        invoiceNumber: `PLX/${yr}/000002`,
        transactionId: "TXN1002",
      },
      {
        enrollment: enrC1._id,
        student: student1._id,
        amount: 22000,
        method: "bank_transfer",
        status: "completed",
        paidOn: dayAt(-30, 10),
        invoiceNumber: `PLX/${yr}/000003`,
        transactionId: "TXN1003",
      },
      {
        enrollment: enrA2._id,
        student: student2._id,
        amount: 25000,
        method: "upi",
        status: "completed",
        paidOn: dayAt(-25, 10),
        invoiceNumber: `PLX/${yr}/000004`,
        transactionId: "TXN1004",
      },
      {
        enrollment: enrB3._id,
        student: student3._id,
        amount: 25000,
        method: "card",
        status: "completed",
        paidOn: dayAt(-15, 10),
        invoiceNumber: `PLX/${yr}/000005`,
    ...
    await Certificate.insertMany([
      {
        ...
        batch: batchA._id,
        enrollment: enrA2._id,
        certificateNumber: `PLX-CERT-${yr}-00001`,
        type: "completion",
        grade: "A+",
        score: 92,
        issuedDate: dayAt(-5, 10),
        studentNameSnapshot: "Sneha Patel",
        courseNameSnapshot: "Full Stack Web Development",
        issuedBy: admin._id,
      },
      {
        student: student1._id,
        ...
        batch: batchC._id,
        enrollment: enrC1._id,
        certificateNumber: `PLX-CERT-${yr}-00002`,
        type: "completion",
        grade: "A",
        score: 88,
        issuedDate: dayAt(-2, 10),
        studentNameSnapshot: "Arjun Reddy",
        courseNameSnapshot: "SAP FICO",
        issuedBy: admin._id,
      },
    ]);
    ...
    await Review.insertMany([
      {
        ...
        title: "Best mentor!",
        comment:
          "Priya ma'am explains React concepts incredibly well. Always patient and clear.",
        aspects: { teaching: 5, content: 5, support: 5, practical: 4 },
        wouldRecommend: true,
      },
      {
        student: student2._id,
        targetType: "course",
        target: fullStack._id,
        rating: 4,
        title: "Great course",
        comment:
          "Loved the hands-on projects. Would like even more live coding sessions.",
        wouldRecommend: true,
      },
      {
        student: student3._id,
        ...
        target: admin._id,
        rating: 5,
        title: "Highly recommend Placeonix",
        comment:
          "Real IT workspace and excellent placement support. Got referred to top companies.",
        wouldRecommend: true,
      },
      {
        student: student1._id,
        ...
        target: sapFico._id,
        rating: 5,
        title: "Live SAP access is a game changer",
        comment: "Practising on real SAP servers made all the difference.",
        wouldRecommend: true,
      },
    ]);
    ...
    await JoinRequest.insertMany([
      {
        ...
        course: sapFico._id,
        mentor: mentor1._id,
        requestedDate: dayAt(1, 8),
        reason:
          "Travelling this week — would like to attend the AR class online.",
        status: "pending",
      },
      {
        student: student1._id,
        ...
        course: sapFico._id,
        mentor: mentor1._id,
        requestedDate: dayAt(-2, 8),
        reason: "Was unwell, requested remote access.",
        status: "approved",
        meetingLink: "https://meet.google.com/placeonix-live",
        respondedBy: mentor1._id,
        respondedAt: dayAt(-3, 12),
      },
    ]);
    ...
    await Assignment.create({
      title: "Node REST API",
      description: "Build a CRUD API with authentication",
      course: fullStack._id,
      batch: batchA._id,
    ...
    await PlacementDrive.create({
      ...
      description:
        "5 openings for fresh graduates with React + Node experience.",
      requirements: ["React.js", "Node.js", "MongoDB"],
      package: { min: 5.5, max: 6, currency: "INR" },
      location: ["Hyderabad", "Bengaluru"],
      workMode: "hybrid",
      vacancies: 5,
      eligibleCourses: [fullStack._id],
    ...
    await PlacementDrive.create({
      ...
      workMode: "onsite",
      vacancies: 10,
      eligibleCourses: [fullStack._id, dataSci._id],
    ...
    await Notification.create({
      ...
      message: "Full Stack Developer - 5.5 LPA",
      priority: "high",
    ...
    await Notification.create({
      ...
      message: "React Portfolio Project — Due in 7 days",
