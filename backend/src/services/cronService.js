    ...
    try {
      ...
      for (const e of enrollments) {
        try {
          ...
          logger.error(`[CRON] Attendance warning failed for student ${e.student}: ${err.message}`);
        }
      }
    ...
    try {
      ...
      for (const a of assignments) {
        try {
          ...
          logger.error(`[CRON] Assignment reminder failed for assignment ${a._id}: ${err.message}`);
        }
      }
