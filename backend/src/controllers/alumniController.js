...
const pickAlumniFields = (body) => {
  ...
  if (typeof out.name === "string")
    out.name = out.name.trim().replace(/\b\w/g, (c) => c.toUpperCase());
  if (typeof out.role === "string")
    out.role = out.role.trim().replace(/\b\w/g, (c) => c.toUpperCase());
