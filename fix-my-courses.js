const fs = require('fs');
let code = fs.readFileSync('frontend/src/app/dashboard/my-courses/page.tsx', 'utf8');

const startStr = "  return (";
const endStr = "  );\n}";
const startIndex = code.indexOf(startStr);
const endIndex = code.lastIndexOf(endStr) + endStr.length;
...
fs.writeFileSync('frontend/src/app/dashboard/my-courses/page.tsx', code);
console.log('Fixed');
